...
int main (int argc, const char *argv[])
{
  ...
  try
  {
    ...
    if (!result.count ("omit"))
    {
      ...
      LOG_I << lib->getEmojiesFromGroup ("Smileys & Emotion");
      LOG_I << lib->getEmojiesFromGroup ("People & Body");
      LOG_I << lib->getEmojiesFromGroup ("Component");
      LOG_I << lib->getEmojiesFromGroup ("Animals & Nature");
      LOG_I << lib->getEmojiesFromGroup ("Food & Drink");
      LOG_I << lib->getEmojiesFromGroup ("Travel & Places");
      LOG_I << lib->getEmojiesFromGroup ("Activities");
      LOG_I << lib->getEmojiesFromGroup ("Objects");
      LOG_I << lib->getEmojiesFromGroup ("Symbols");
      LOG_I << lib->getEmojiesFromGroup ("Flags") << std::endl;
    }
    else
    {
